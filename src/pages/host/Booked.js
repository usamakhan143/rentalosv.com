      ...
      <div className="flex-1 ml-20">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold" style={{ color: "#003552" }}>Booked</h1>
          ...
          <div className="text-center">
            <div className="mb-8">
              <img
                ...
                alt="No booked trips illustration"
                className="w-64 h-auto mx-auto"
              />
            </div>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">No booked trips</h2>
